package com.fun.oss.utils;

import com.aliyun.oss.ClientException;
import com.aliyun.oss.OSS;
import com.aliyun.oss.OSSException;
import com.aliyun.oss.model.*;
import com.fun.oss.config.AliyunOssConfig;
...
public class AliyunOSSUtil {
	 ...
	 */
	public Result<?> uploadImage(MultipartFile uploadFile,  String directory) {
...
//		String uploadImageUrl = ossConfig.getBucketName() + "/" + filePath + "/" + newFileName;
		String uploadImageUrl = ossConfig.getBucketName() + "/" + newFileName;
	 ...
	 * 上传文件
	 * @param file 文件
	 * @param directory 指定bucket中的目录
	 * @return 文件上传成功,返回文件完整访问路径
	 */
	 ...
	 * 根据文件名生成文件的访问地址
	 */
	private String getOssUrl(OSS ossClient, String key) {
