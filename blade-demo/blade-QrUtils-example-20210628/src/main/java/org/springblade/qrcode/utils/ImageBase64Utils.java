...
//		String str = imageToBase64String("E:\\Desktop\\sign.png");
//		System.out.println(str);

		String prefix = "data:image/jpg;base64,";

		try(FileInputStream inputStream = new FileInputStream("E:\\Desktop\\sign.txt")) {
			String qrString = IOUtils.toString(inputStream, StandardCharsets.UTF_8);
			saveBase64ImageStringToImage("E:\\Desktop\\", "test", prefix + qrString);
		}
	}
