package com.fun.flowable.controller;


import com.dapeng.flow.common.result.ResponseData;
import com.fun.flowable.common.utils.BeanUtils;
import com.fun.flowable.flowable.handler.HistTaskQueryHandler;
import com.fun.flowable.flowable.handler.TaskHandler;
import com.fun.flowable.flowable.handler.TaskQueryHandler;
import com.fun.flowable.repository.model.HistTaskVO;
