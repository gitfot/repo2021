package com.fun.flowable.flowable.handler;


import com.fun.flowable.common.utils.BeanUtils;
import com.fun.flowable.flowable.ActInstance;
import com.fun.flowable.flowable.ServiceFactory;
import com.fun.flowable.repository.model.TaskVO;
...
public class InstanceHandler extends ServiceFactory implements ActInstance {
    ...
    @Autowired
    private com.fun.flowable.flowable.handler.TaskHandler taskHandler;
    @Autowired
    private com.fun.flowable.flowable.handler.TaskQueryHandler taskQueryHandler;
